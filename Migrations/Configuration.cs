    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MVCBlog.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(MVCBlog.Models.ApplicationDbContext context)
        {
            ...
            if (!context.Users.Any())
            {
                ...
                CreateUser(context, "admin@gmail.com", "123", "System Administrator", "Administrators");
                CreateUser(context, "pesho@gmail.com", "123", "Peter Ivanov","Training Staff");
                CreateUser(context, "merry@gmail.com", "123", "Maria Petrova","Trainer");
                CreateUser(context, "geshu@gmail.com", "123", "George Petrov","Trainee");

                CreateRole(context, "Administrators");
                CreateRole(context, "Training Staff");
        ...
        private void CreateUser(ApplicationDbContext context,
            string email, string password, string fullName,string userRole)
        {
